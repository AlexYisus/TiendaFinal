    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country_region', models.CharField(choices=[('Latacunga', 'Latacunga'), ('Pangua', 'Pangua'), ('Pujilí', 'Pujilí'), ('Salcedo', 'Salcedo'), ('Saquisilí', 'Saquisilí'), ('Sigchos', 'Sigchos')], default='Latacunga', max_length=255)),
